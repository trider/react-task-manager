...
const TaskTable = () => {
  ...
  const [taskNameUpdate, setTaskName] = useState(task.name);
  const [taskDescriptionUpate, setTaskDescription] = useState(task.description);
    ...
    setTasks(tasks.map((t) => {
      if (t.taskId === task.taskId) {
        t.isEdit = !t.isEdit;
        t.name = taskNameUpdate;
        t.description = taskDescriptionUpate;
