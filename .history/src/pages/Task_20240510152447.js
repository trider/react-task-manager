      ...
      return <tbody>
        {tasks.map((task) => (
          <tr key={task.id}>
            ...
            <td>
              {/* {getButton(task)} */}
              <ModalComponent title='Edit' tasks={tasks} onAddTask={addTask} size='sm' />
            </td>
            <td>
        ...
        <tr style={{height:"40px"}}>
          ...
          <div className="d-grid gap-2 d-md-flex justify-content-md-center">
            ...
            title='Add' 
            tasks={tasks} 
            task={{name: taskName, description: taskDescription, user: 'jonnygold', status: 'do', taskId: tasks.length + 1, added: new Date().toISOString(), updated: new Date().toISOString(), isActive: true, isEdit: false}
            onAddTask={addTask} 
